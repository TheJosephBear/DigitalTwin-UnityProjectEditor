...
namespace TransformGizmos
{
    public class Rotation : MonoBehaviour
    {
        ...
        public void Initialization(GameObject targetObject, Material clickedMaterial, Material gizmoTransparentMaterial, GameObject objectWithMeshes, GameObject degreesText, GameObject rotationAppendix, float startingPivotSize)
        {
       ...
       //     m_initialDegreesTextScale = m_degreesText.transform.localScale.x;
            m_initialScale = startingPivotSize;
            m_initialDegreesTextScale = startingPivotSize;
