...
namespace TransformGizmos
{
    public class Scaling : MonoBehaviour
    {
        ...
        public void Initialization(GameObject targetObject, Material clickedMaterial, Material transparentMaterial, float startingPivotSize)
        {
            m_targetObject = targetObject;
            m_clickedMaterial = clickedMaterial;
            m_transparentMaterial = transparentMaterial;
            m_initialScale = startingPivotSize/50;
        }
