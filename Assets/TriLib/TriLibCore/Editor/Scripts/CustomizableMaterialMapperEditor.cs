...
namespace TriLibCore.Editor
{
    ...
    public class CustomizableMaterialMapperEditor : UnityEditor.Editor
    {
        ...
        private static readonly string[] PropertyDescriptions =
        {
            ...
            "Smoothness/Roughness Strength (No Textures)",
            "Smoothness/Roughness Strength (Textures)",
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (var i = 0; i < CustomizableMaterialMapper.GenericPropertiesCount; i++)
            {
                ...
                EditorGUILayout.PropertyField(value, new GUIContent(PropertyDescriptions[i] + " (" + Enum.GetName(typeof(GenericMaterialProperty), (GenericMaterialProperty)CustomizableMaterialMapper.GenericPropertyIndices[i]) + ")"));
            }
