...
namespace TriLibCore.Fbx
{
    public class FBXMaterial : FBXObject, IMaterial
    {
        ...
        public bool IsPhongMaterial => ShadingModel == null ? false : ShadingModel.Equals("Phong", StringComparison.InvariantCultureIgnoreCase) || ShadingModel.Equals("Lambert", StringComparison.InvariantCultureIgnoreCase);
