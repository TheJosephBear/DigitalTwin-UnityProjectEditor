...
namespace TriLibCore.Mappers
{
    ...
    public abstract class MaterialMapper : ScriptableObject
    {
        ...
        /// </summary>
        /// <param name="materialMapperContext">Context containing the TriLib virtual material and Unity material references.</param>
        [Obsolete("Use the override with the 'hasTexture' flag")]
        ...
        public virtual string GetGlossinessOrRoughnessName(MaterialMapperContext materialMapperContext, bool hasTexture) => null;
        ...
        protected void BuildMaterial(MaterialMapperContext materialMapperContext)
        {
            ...
            var hasGlossinessTexture = materialMapperContext.VirtualMaterial.GenericPropertyIsSetAndValid(GenericMaterialProperty.GlossinessOrRoughness);
            var glossinessOrRoughnessName = GetGlossinessOrRoughnessName(materialMapperContext, hasGlossinessTexture);
