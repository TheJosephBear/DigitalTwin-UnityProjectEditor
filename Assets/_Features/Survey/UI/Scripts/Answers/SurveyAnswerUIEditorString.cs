...
public class SurveyAnswerUIEditorString : SurveyAnswerUIEditor {
    ...
    public SurveyAnswerUIEditorString(VisualElement answerElement, int answerIndex, SurveyQuestionUIEditorString questionUI, bool isOther) 
    ...
    private SurveyQuestionUIEditorString _questionUIRef;
