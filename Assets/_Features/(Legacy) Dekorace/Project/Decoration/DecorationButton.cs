...
public class DecorationButton : MonoBehaviour {
    ...
    public void Initialize(DecorationPreset deco) {
        ...
        button.onClick.AddListener(() => FindAnyObjectByType<DecorationUI>().RefreshDecorationButtonListSelection()); // Nechuťárna ale nevím jak jinak aktualizovat ty outline všech tlačítek
